...
const baseCategories = [
    ...
    { name: "Market Trends", icon: <BarChart3 size={18} />, color: "from-amber-500 to-orange-500" },
    { name: "Neighborhood Guides", icon: <BookOpen size={18} />, color: "from-emerald-500 to-teal-500" },
    { name: "Investment Tips", icon: <Wallet size={18} />, color: "from-rose-500 to-pink-500" },
...
export default function BlogFilters({ activeCategory, setActiveCategory }: BlogFiltersProps) {
    ...
    useEffect(() => {
        // Calculate counts from local blogPosts
        ...
        // Ensure all base categories are represented in counts
        baseCategories.forEach(cat => {
            if (newCounts[cat.name] === undefined) {
